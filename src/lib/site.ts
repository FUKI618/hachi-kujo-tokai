...
export const siteConfig = {
  defaultTitle:
    "東海の蜂の巣駆除なら最短30分｜基本1,680円〜・1年保証｜蜂の巣駆除ファクトリー東海",
  defaultDescription:
    "蜂の巣駆除を愛知・岐阜・三重・静岡で最短30分。事前見積金額の範囲内で追加請求なしのハチ駆除専門【蜂の巣駆除ファクトリー東海】。スズメバチ¥2,680〜・アシナガバチ¥1,680〜、基本1,680円〜。24時間365日受付・見積り無料・キャンセル料0円・1年再発保証。",
