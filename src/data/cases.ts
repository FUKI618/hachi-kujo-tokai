...
export const cases: Case[] = [
  ...
  },
  {
    ...
    priceJpy: 9800,
    priceFactors:
      "比較的おとなしいアシナガバチで、手が届く高さ2mのベランダ手すり。短時間で安全に撤去でき、基本1,680円〜に巣の規模分のみ加算した事例です。",
  ...
  },
  {
    ...
    priceJpy: 7500,
    priceFactors:
      "働き蜂が増える前に早期発見できた、手の届く庭木1.5mの小さな巣。短時間で安全に駆除でき、基本1,680円〜に近い金額で収まった事例です。早く相談するほど安くなる典型例。",
