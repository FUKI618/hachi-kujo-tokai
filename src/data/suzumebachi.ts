...
export const suzumeCases: Case[] = [
  {
    ...
    priceJpy: 24000,
    priceFactors:
      "働き蜂が増えた成熟巣。防護装備での慎重な作業と脚立を要する高さのため、基本2,680円〜にサイズ・高所分を加算した事例です。",
  ...
  },
  {
    ...
    area: "一宮市",
    location: "屋根裏",
    title: "屋根裏の羽音の正体、キイロスズメバチの巣を撤去",
    priceJpy: 38000,
    priceFactors:
      "「天井から羽音がする」とのご相談。屋根裏の巣は位置特定・狭所作業・侵入口の封鎖まで必要なため、通常の巣より加算されます。",
    priceBreakdown: ["キイロスズメバチ", "屋根裏", "侵入口封鎖", "狭所作業"],
  },
  {
    id: "suzume-03",
    imageBase: "suzume-03",
...
export const suzumeVoices: Voice[] = [
  {
    ...
    rating: 5,
    comment:
      "最初は基本料金の安さに少し不安もありましたが、現地で2万円台と提示され、その金額から一切上がらず安心でした。他社では4万円と言われた巣です。子どもがいるので即日対応も助かりました。",
  },
  {
    initial: "I",
    area: "一宮市",
