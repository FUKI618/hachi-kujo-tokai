...
export const nagoyaCases: Case[] = [
  {
    ...
    priceJpy: 24000,
    priceFactors:
      "攻撃性の高いスズメバチ＋脚立を要する軒下2.5m。防護装備での慎重作業のため、サイズ・高所分を加算した事例です。",
  ...
  },
  {
    ...
    priceJpy: 8800,
    priceFactors:
      "手が届く高さのベランダ手すりの小〜中規模巣。短時間で安全に撤去でき、巣の規模分のみ加算した事例です。",
  ...
  },
  {
    ...
    priceJpy: 7800,
    priceFactors:
      "働き蜂が増える前に早期発見できた、手の届く物置の軒の小さな巣。短時間で安全に駆除でき、小規模ゆえ低めの金額で収まった事例です。",
